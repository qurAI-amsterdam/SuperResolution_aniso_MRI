'''
    Implementation from https://gist.github.com/alper111/b9c6d80e2dba1ee0bfac15eb7dad09c8
...
def gauss_kernel(device=DEVICE, channels=3):
...
class LapLoss(torch.nn.Module):
    def __init__(self, max_levels=3, channels=3, device=DEVICE):
